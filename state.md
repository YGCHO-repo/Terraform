...
subnets = {
  "10.50.10.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-06e1731a5812f62fd"
  ...
  "10.50.110.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-02c4e9df503563583"
    "assign_ipv6_address_on_creation" = false
    "availability_zone" = "ap-northeast-2a"
    "availability_zone_id" = "apne2-az1"
  ...
  "10.50.120.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-009d1d53fcda49ea2"
    "assign_ipv6_address_on_creation" = false
  ...
  "10.50.130.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-072ba16cd51fbc4ad"
    "assign_ipv6_address_on_creation" = false
    "availability_zone" = "ap-northeast-2a"
    "availability_zone_id" = "apne2-az1"
  ...
  "10.50.140.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-066eb7b714f79182c"
    "assign_ipv6_address_on_creation" = false
    "availability_zone" = "ap-northeast-2c"
    "availability_zone_id" = "apne2-az3"
  ...
  "10.50.20.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-02f472a125383a1b2"
    "assign_ipv6_address_on_creation" = false
    "availability_zone" = "ap-northeast-2c"
    "availability_zone_id" = "apne2-az3"
  ...
  "10.50.210.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-0f544b359505d09ae"
    "assign_ipv6_address_on_creation" = false
    "availability_zone" = "ap-northeast-2a"
    "availability_zone_id" = "apne2-az1"
  ...
  "10.50.220.0/24" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:subnet/subnet-00cbc5b299fc6333f"
    "assign_ipv6_address_on_creation" = false
    "availability_zone" = "ap-northeast-2c"
    "availability_zone_id" = "apne2-az3"
...
security_groups = {
  "backend" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:security-group/sg-0491a9ad052a4e7f6"
  ...
  "bastion" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:security-group/sg-00befa1c5be61d1c6"
    "description" = "Managed by Terraform"
    "egress" = toset([])
  ...
  "front" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:security-group/sg-00c48fdc852703eeb"
    "description" = "Managed by Terraform"
    "egress" = toset([])
  ...
  "rds" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:security-group/sg-0fb0f907e9efdf8d5"
    "description" = "Managed by Terraform"
    "egress" = toset([])
  ...
  "was" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:security-group/sg-0729ccc3c5b27b8d6"
    "description" = "Managed by Terraform"
    "egress" = toset([])
  ...
  "web" = {
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:security-group/sg-02399b788fe26d4fe"
    "description" = "Managed by Terraform"
    "egress" = toset([])
...
ec2_instances = {
  "bastion" = {
    ...
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:instance/i-05a034e0b17d3405a"
  ...
  "was_a" = {
    "ami" = "ami-0c76973fbe0ee100c"
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:instance/i-074f32f978578c422"
    "associate_public_ip_address" = false
    "availability_zone" = "ap-northeast-2a"
    "capacity_reservation_specification" = tolist([
      {
  ...
  "was_c" = {
    "ami" = "ami-0c76973fbe0ee100c"
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:instance/i-09995e8a0affe7c53"
    "associate_public_ip_address" = false
    "availability_zone" = "ap-northeast-2c"
    "capacity_reservation_specification" = tolist([
      {
  ...
  "web_a" = {
    "ami" = "ami-0c76973fbe0ee100c"
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:instance/i-0459dbb8f5278e5e4"
    "associate_public_ip_address" = false
    "availability_zone" = "ap-northeast-2a"
    "capacity_reservation_specification" = tolist([
      {
  ...
  "web_c" = {
    "ami" = "ami-0c76973fbe0ee100c"
    "arn" = "arn:aws:ec2:ap-northeast-2:561132301435:instance/i-0026cdc220464aaa3"
    "associate_public_ip_address" = false
    "availability_zone" = "ap-northeast-2c"
    "capacity_reservation_specification" = tolist([
      {
...
alb_tg_attach_ids = {
  "was_a" = "arn:aws:elasticloadbalancing:ap-northeast-2:561132301435:targetgroup/test-tf-backend-alb-tg/ab462a24be340d4d-20220923095906453700000001"
  "was_c" = "arn:aws:elasticloadbalancing:ap-northeast-2:561132301435:targetgroup/test-tf-backend-alb-tg/ab462a24be340d4d-20220923095906537800000004"
  "web_a" = "arn:aws:elasticloadbalancing:ap-northeast-2:561132301435:targetgroup/test-tf-front-alb-tg/a9382c1a1b9e0079-20220923095906537700000003"
  "web_c" = "arn:aws:elasticloadbalancing:ap-northeast-2:561132301435:targetgroup/test-tf-front-alb-tg/a9382c1a1b9e0079-20220923095906484700000002"
}
alb_tg_ids = {
  "backend" = "arn:aws:elasticloadbalancing:ap-northeast-2:561132301435:targetgroup/test-tf-backend-alb-tg/ab462a24be340d4d"
  "front" = "arn:aws:elasticloadbalancing:ap-northeast-2:561132301435:targetgroup/test-tf-front-alb-tg/a9382c1a1b9e0079"
}
```
...
db_parameter_group = {
  "msc_rds_aurora" = {
    "arn" = "arn:aws:rds:ap-northeast-2:561132301435:pg:test-tf-aurora-mysql8-0-parameter-group"
    "description" = "test-tf-aurora-mysql8-0-parameter-group"
    "family" = "aurora-mysql8.0"
    "id" = "test-tf-aurora-mysql8-0-parameter-group"
    "name" = "test-tf-aurora-mysql8-0-parameter-group"
